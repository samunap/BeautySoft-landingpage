      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 bg-primary-100 text-primary-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            {t.features.ctaTitle.includes("trasformare")
              ? "Demo Live"
              : "Live Demo"}
          </div>
          <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-600 bg-clip-text text-transparent mb-6">
            {t.features.ctaTitle.includes("trasformare")
              ? "Scopri BeautySoft in Azione"
              : "See BeautySoft in Action"}
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            {t.features.ctaTitle.includes("trasformare")
              ? "Scopri l'interfaccia intuitiva progettata per i professionisti della bellezza e i loro clienti"
              : "Experience the intuitive interface designed for beauty professionals and their customers"}
          </p>
        </div>
